    ...
    return (
        <div className="max-w-4xl mx-auto my-10 p-6 bg-white shadow-lg rounded-lg">
            ...
            <div className="flex items-center gap-4 p-4 bg-gray-100 rounded-lg shadow">
                <img
                    src={recipe?.userProfileImage || profileImg}
            ...
            {/* Recipe Title */}
            <h3 className="text-4xl font-bold text-center text-violet-700 mt-6">
            ...
            <div className="flex justify-center mt-6">
                <img
                    src={recipe?.coverImage ? `${API_URL}/${recipe.coverImage}` : "https://via.placeholder.com/350x300"}
